...
namespace App\Http\Livewire\Admin\Modal\Purchase;
...
class ModalPurchase extends Component
{
    ...
    public $classSize= 'modal-xl';
    public $idModal= 'PurchaseModal';
    public $method = '';
    public $action = '';
    public $nameComponent = 'Compras';

    protected $listeners = ['toogleModalPurchase'];
    ...
    public function render()
    {
        ...
        return view('livewire.admin.modal.purchase.modal-purchase',compact(
            'cart_content', 'total', 'products', 'items_count'
        ));
    }
    ...
    public function toogleModalPurchase($model_id = null,$model= null){

        if($model_id && $model){
            $this->target = $model == 'Purchase' ? Purchase::find($model_id) : '';
