            ...
            <div class="input-group col-md-12">
                    ...
                    @if($this->active_brand_update)
                        ...
                        <span class="input-group-btn pl-2">
                            <button class="btn btn-dark" wire:click.prevent="editBrand"><i class="fa fa-floppy-disk"></i></button>
                    ...
                    <tr>
                        ...
                        <td>
                                ...
                                <a href="javascript:void(0)" class="btn btn-danger"
                                   wire:click="deleteBrand({{ $brand->id }})" data-toggle="tooltip" data-placement="top"
