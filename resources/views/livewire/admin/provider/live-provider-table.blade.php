                ...
                <div class="col-md-6">
                    ...
                    @can('usuario create')
                        <div class="btn-group mb-1">
                            <button class="btn btn-dark color-basic " wire:click="$emit('toogleModalProvider')" type="button" data-toggle="tooltip"
                                    data-placement="top" title="Crear nuevo proveedor">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th width="15%" wire:click="sortable('ruc')" class="th-pointer table-th text-center" scope="col">Ruc
                            <span class=" th-span fa fa{{ $camp === 'ruc' ? $icon : '-sort' }}"></span>
                        </th>

                        <th wire:click="sortable('phone')" class="th-pointer table-th text-center" scope="col">Celular
                            <span class=" th-span fa fa{{ $camp === 'phone' ? $icon : '-sort' }}"></span>
                        </th>
                    ...
                    @if ($providers->count())
                        ...
                        @foreach ($providers as $provider)
                            <tr class="tr-custom">
                                ...
                                <td>
                                    <h6>
                                        <span class=" badge {{ $provider->provider_status->id == 1 ? 'badge-success-inverse ' : 'badge-danger-inverse'}}">
