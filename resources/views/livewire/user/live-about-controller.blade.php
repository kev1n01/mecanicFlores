@section('title','Nosotros Enetero')
<div>
    <div class="container">
        <div class="about-us intro" style="padding-top: 20px !important;>
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="intro-header">
                            <h3>Bienvenido a Enetero</h3>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="effect">
                            <a href="#">
                                <img class="img-responsive" src="{{asset('assetsuser/img/intro-1.png')}}" alt="Intro Image">
                            </a>
                        </div>
                    </div>
